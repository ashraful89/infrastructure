module "common" {
  ...
  aad_tenant_id                          = local.aad_production_tenant_id
  aad_client_id                          = local.aad_production_client_id
  aad_client_secret                      = var.aad_production_client_secret
  aad_extension_app_client_id            = local.aad_production_extension_app_client_id
